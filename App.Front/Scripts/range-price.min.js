$(function () {
    ...
    $(document).on('change', 'input[name=attr]', function (e) {
        ...
        $("#attribute").val(value.toString());
        var data = {
            attribute: value
        }
        range.getcontent(data, e, "attribute", value);
    });
    $(document).on('change', 'input[name=productold]', function (e) {
        e.preventDefault();
        $("#content-ajax").addClass("ajax-loading");
        var value = getProOldChecbox();
        //  $("#productold").valvalue);
        var data = {
            olproduct: value
        }
        range.getcontent(data, e, "productold", value);
    });
    $(document).on('change', 'input[name=productnew]', function (e) {
        e.preventDefault();
        $("#content-ajax").addClass("ajax-loading");
        var value = getProNewChecbox();
        //  $("#productold").valvalue);
        var data = {
            olproduct: value
        }
        range.getcontent(data, e, "productnew", value);
    });
...
function getProOldChecbox() {
    var boxes = $('input[name=productold]:checked');
    var boxesValue = boxes.val();

    return boxesValue;
}
function getProNewChecbox() {
    var boxes = $('input[name=productnew]:checked');
    var boxesValue = boxes.val();
