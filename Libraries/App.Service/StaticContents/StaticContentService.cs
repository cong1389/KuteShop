...
using App.Infra.Data.Repository.StaticContents;
...
namespace App.Service.StaticContents
{
    public class StaticContentService : BaseService<StaticContent>, IStaticContentService
    {
        ...
        public StaticContentService(IUnitOfWork unitOfWork, IStaticContentRepository staticContentRepository,
            ICacheManager cacheManager) : base(unitOfWork, staticContentRepository)
        {
