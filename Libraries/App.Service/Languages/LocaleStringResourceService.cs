...
using App.Infra.Data.Repository.LocaleStringResources;
...
{
    public class LocaleStringResourceService : BaseService<LocaleStringResource>, ILocaleStringResourceService
    {
        ...
        public void CreateLocaleStringResource(LocaleStringResource localeStringResource)
        {
            _localeStringResourceRepository.Add(localeStringResource);
        }

        public LocaleStringResource GetByName(int languageId, string resourceName, bool isCache = true)
        {
            LocaleStringResource locale;
            ...
            if (isCache)
            {
                ...
                locale = _cacheManager.Get<LocaleStringResource>(key);
                if (locale == null)
                {
        ...
        public IEnumerable<LocaleStringResource> PagedList(SortingPagingBuilder sortbuBuilder, Paging page)
        {
        ...
        public LocaleStringResource GetById(int id, bool isCache = true)
        {
            LocaleStringResource locale;
        ...
        public virtual IQueryable<LocaleStringResource> GetAll(int languageId)
        {
