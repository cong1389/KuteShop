...
{
    public class UserManagerService : UserManager<IdentityUser, Guid>, IUserManagerService
    {
        public UserManagerService(IUserStore<IdentityUser, Guid> store, IIdentityMessageService emailService, IDataProtectionProvider dataProtectionProvider) : base(store)
        {
